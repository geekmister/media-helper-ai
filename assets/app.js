const UI_TEXT = {
  zh: {
    ...
    article1Tag: 'Traffic',
    article1Title: '你写的知乎回答为什么没人看？不是因为你写的不好，而是问题没流量！',
    article1Desc: '很多回答没人看，不是表达问题，而是你一开始就选中了没有自然流量的问题。',
    article2Tag: 'Monetization',
    article2Title: '什么样的知乎问题回答后更容易变现？',
    article2Desc: '真正有商业价值的问题，往往自带决策意图、购买场景和明确的人群需求。',
    article3Tag: 'Warning',
    article3Title: '带有这几种标签的知乎问题千万不要答！！！',
    article3Desc: '高竞争、低搜索、低承接的题目会持续消耗时间，却很难带来增长结果。',
    footerBrand: '媒体助手 AI',
  ...
  en: {
    ...
    article1Tag: 'Traffic',
    article1Title: 'Why nobody reads your Zhihu answers',
    article1Desc: 'In many cases the real problem is not the writing quality, but the lack of traffic on the selected question.',
    article2Tag: 'Monetization',
    article2Title: 'What kinds of Zhihu questions monetize better?',
    article2Desc: 'The most valuable questions usually carry decision intent, purchase context, and a clear demand signal.',
    article3Tag: 'Warning',
    article3Title: 'These Zhihu question tags are not worth answering',
    article3Desc: 'High-competition and low-intent topics often consume time without creating meaningful growth.',
